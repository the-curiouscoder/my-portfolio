            ...
            <form onSubmit={handleSubmit} className="space-y-6 p-6 m-4 bg-black/40 rounded-lg">
              <div>
                ...
                <input
                  ...
                  className="cyber-input w-11/12 rounded-lg px-4 py-4 text-white text-base focus:border-cyber-gold outline-none transition-all duration-300"
                  required
                />
              </div>
              ...
              <div>
                <label className="block w-11/12 text-cyber-gold font-semibold mb-2">Project Type</label>
                <select
                  name="projectType"
                  value={formData.projectType}
                  onChange={handleChange}
                  className="cyber-input w-full rounded-lg px-4 py-4 text-white text-base focus:border-cyber-gold bg-grey outline-none transition-all duration-300"
                >
                  <option value="" className="text-black bg-white">Select project type</option>
                  <option value="web-app" className="text-black ">Web Application</option>
                  <option value="ui-ux" className="text-black ">UI/UX Design</option>
                  <option value="data-entry " className="text-black ">Data Entry & File conversion </option>
                  <option value="ui-content-writing" className="text-black ">Content Writing and Proofreading </option>
              ...
              <div>
                <label className="block w-11/12 text-cyber-gold font-semibold mb-2">Message</label>
                <textarea
                  name="message"
                  ...
                  className="cyber-input w-11/12 rounded-lg py-3 px-4  text-white text-base focus:border-cyber-gold outline-none transition-all duration-300 resize-none"
                  required
                />
              </div>
